...
public class WeaponDec : MonoBehaviour {
    ...
    public Animator frontArmAnimator;
    private AudioSource inkShootSound;
	...
	void Awake() {
        ...
        inkShootSound = GetComponent<AudioSource>();
	}
	...
	void Shoot() {
        ...
        frontArmAnimator.Rebind();
        frontArmAnimator.SetBool("Shooting", true);
    ...
    {
        frontArmAnimator.SetBool("Shooting", false);
    }
}
